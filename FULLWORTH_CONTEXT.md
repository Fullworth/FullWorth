...
- `development`: `6db99dda0bc02fbb0440579da4924a82257ba786` (PR #196 PWA update flow merged; exact head `fc188d5bf4098aab7abf6693bd855a9c59655113`, full CI #699)
...
1. Current `development` is `6db99dda0bc02fbb0440579da4924a82257ba786` (PR #196 squash merge; exact PWA-update head `fc188d5bf4098aab7abf6693bd855a9c59655113`, full CI #699). It contains the completed consumer v2 work, PRs #182–#186 for GitHub-rendered visual acceptance/navigation fixes, dependency maintenance from PRs #176/#177, PR #188's Chromium PWA/offline proof, PR #189's responsive-browser Back navigation proof, PR #191's BFF session-expiry fix/acceptance, PR #193's browser security-dialog acceptance, PR #195's cost-aware validation cadence, and PR #196's controlled user-visible PWA update flow.
