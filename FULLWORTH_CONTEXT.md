...
- `development`: `d11f528` (PR #193 security-dialog acceptance merged; exact head `77b22b34ca757b8f92f7ba08f89c2edec2bed9f0`, CI `35687185230`)
...
1. Current `development` is `d11f528` (PR #193 merge; exact security-dialog acceptance head `77b22b34ca757b8f92f7ba08f89c2edec2bed9f0`, CI run `35687185230`). It contains the completed consumer v2 work, PRs #182–#186 for GitHub-rendered visual acceptance/navigation fixes, dependency maintenance from PRs #176/#177, PR #188's Chromium PWA/offline proof, PR #189's responsive-browser Back navigation proof, PR #191's BFF session-expiry fix/acceptance, and PR #193's browser security-dialog acceptance.
...
7. The next UI acceptance work is real installed-device / interaction validation: installed Android PWA, iOS home-screen PWA where available, keyboard resize, Android/iOS hardware-back behavior, install/update behavior, Plaid Hosted Link return, and statement file picker. Browser security-dialog behavior is covered by PR #193; installed-device dialog behavior remains part of the device gate.
