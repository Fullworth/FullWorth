...
- Current `development`: `e2eb0cceaf1cb7fbacbaddd791f235da490ff364` after PR #320 added strong reauthentication for Admin/Moderator role assignment.
...
3. Continue security issue #291 in small reviewable slices. Strong reauthentication remains an active operation-by-operation audit: PR #316 hardened privileged access-key creation and PR #320 hardened staff-role assignment. Next inspect privilege-granting subscription entitlements and program-membership activation, then sensitive account export; patch only confirmed gaps and keep defensive revocations/deactivation friction-light where that improves incident response.
