...
- The current promoted product-code baseline is development head `d4ab89de5a7a0ff1407c1188defd199c1a0e3d04`, promoted through PR #241 to master merge `a5c45ee91aefc30897418919f9ba24b9844afb2a` after exact-head FullWorth CI #806 passed. The master push is undergoing its own CI run #808; do not claim that post-merge run complete until GitHub reports it green.
