...
- Current `development`: `0f102e70c32ba2ac032cd4b72d9a4b002c018364` after PR #318 corrected admin-client handling of strong-reauthentication credential failures.
...
3. Continue security issue #291 in small reviewable slices. Strong reauthentication remains an active operation-by-operation audit: PR #316 closed privileged access-key creation. Next inspect privileged staff-role / entitlement / program mutations and sensitive account export, then patch only a confirmed gap in one bounded workflow; keep defensive revocations friction-light where that improves incident response.
