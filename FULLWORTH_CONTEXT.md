...
- Development is currently `92346faae2cddbe096ca3286d91a434c323141cf` after PR #219 merged the release-pinned installed-device acceptance evidence harness. PR #219 exact head `fe81a2274c9e2ea7b1ca185e18a0ae7ea3958087` passed FullWorth CI #765: backend build/tests (including the new shell evidence regressions) and Linux production/security/backup/recovery passed; MAUI Android was correctly skipped as unrelated.
...
- PR #210 remains open from `development` to `master`, currently tracking head `92346faae2cddbe096ca3286d91a434c323141cf`. Do not promote #210 until the required installed-device interaction evidence exists for that exact release candidate and the promotion head has exact-head CI. Any CI tied to an earlier development head is stale release evidence.
