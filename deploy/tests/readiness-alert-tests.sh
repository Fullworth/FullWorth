...
grep -Fq '"text":"FullWorth readiness alert: readiness-forced-failure for API (run 123456)."' "$argv_capture" || fail "sender payload did not include Slack-compatible message text."
