...
The emulator's ADB-connect and Android-boot waits are deliberately bounded. If the emulator exits or fails to become reachable, the gate fails closed and prints a sanitized emulator-log tail instead of hanging until GitHub cancels the job.
