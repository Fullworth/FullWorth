...
This is a deterministic packaging/install/launch gate. It catches broken signing, malformed packages, install failures, immediate startup crashes, and launcher-registration failures without using a FullWorth account or financial data. It does **not** replace physical-device interaction checks.
